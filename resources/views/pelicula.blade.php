...
<html lang="es">
	...
	<body>
		...
		<header>
			...
			<div class="area-logo">
				<a href="index.html"><img src={{asset("img/varios/logo-cinestar.png")}}></a>
			</div>
			<nav class="menu">
					...
					<div class="datos-pelicula">
						...
						<div class="tabla">
							<div class="fila">
								...
								<div class="celda">{{$row->Titulo}}</div>
							</div>
							<div class="fila">
								<div class="celda-titulo">Estreno :</div>
								<div class="celda">{{$row->FechaEstreno}}</div>
							</div>
							@endforeach
							...
							<div class="fila">
								...
								<div class="celda">{{$row->Director}}</div>
							</div>
							<div class="fila">
								<div class="celda-titulo">Reparto :</div>
								<div class="celda">{{$row->Reparto}}</div>
							</div>
						</div>
					</div>
					<img src="{{ asset('img/pelicula/' . $row->id . '.jpg') }}" width="160" height="226">
				</div>
				@endforeach
			</div>
		</div>
